...
from models_lora.unet_2d_condition import UNet2DConditionModel
...
class RegionDiffusionXL(DiffusionPipeline, FromSingleFileMixin, LoraLoaderMixin):
    r"""
    ...
    ##### Rich-Text: hooks for injecting and collecting attention maps #####
