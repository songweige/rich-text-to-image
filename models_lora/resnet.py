...
from models_lora.attention_processor import SpatialNorm
...
class Upsample1D(nn.Module):
    ...
    def __init__(self, channels, use_conv=False, use_conv_transpose=False, out_channels=None, name="conv"):
        ...
        if use_conv_transpose:
            ...
            self.conv = LoRACompatibleConv(self.channels, self.out_channels, 3, padding=1)
...
class Downsample1D(nn.Module):
    ...
    def __init__(self, channels, use_conv=False, out_channels=None, padding=1, name="conv"):
        ...
        if use_conv:
            self.conv = LoRACompatibleConv(self.channels, self.out_channels, 3, stride=stride, padding=padding)
        else:
