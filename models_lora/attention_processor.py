...
class Attention(nn.Module):
    ...
    def forward(self, hidden_states, real_attn_probs=None, attn_weights=None, encoder_hidden_states=None, attention_mask=None, **cross_attention_kwargs):
        ...
        # self.processor(self,None,encoder_hidden_states=encoder_hidden_states,attention_mask=attention_mask,**cross_attention_kwargs,)
...
class LoRAAttnProcessor(nn.Module):
    ...
    def __call__(
        self, attn: Attention, hidden_states, encoder_hidden_states=None, attention_mask=None, real_attn_probs=None, attn_weights=None, scale=1.0, temb=None
    ):
        residual = hidden_states
