...
# code source: https://github.com/google/prompt-to-prompt/blob/main/ptp_utils.py
...
class LocalBlend:
    ...
    def __init__(self, prompts: List[str], words, threshold=.3, tokenizer=None, device='cuda'):
